...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->fileMap = array(
            ...
            'oc_platform.bigbrother.message_listener' => 'getOcPlatform_Bigbrother_MessageListenerService.php',
            'oc_platform.bigbrother.message_notificator' => 'getOcPlatform_Bigbrother_MessageNotificatorService.php',
            'oc_platform.doctrine_listener.application_creation' => 'getOcPlatform_DoctrineListener_ApplicationCreationService.php',
            'oc_platform.email.application_mailer' => 'getOcPlatform_Email_ApplicationMailerService.php',
            'oc_platform.form.ckeditor' => 'getOcPlatform_Form_CkeditorService.php',
            'oc_platform.purger.advert' => 'getOcPlatform_Purger_AdvertService.php',
            ...
            'security.authentication.listener.anonymous.main_login' => 'getSecurity_Authentication_Listener_Anonymous_MainLoginService.php',
            ...
            'security.authentication.provider.anonymous.main_login' => 'getSecurity_Authentication_Provider_Anonymous_MainLoginService.php',
            ...
            'security.authentication.session_strategy.main_login' => 'getSecurity_Authentication_SessionStrategy_MainLoginService.php',
            ...
            'security.firewall.map.context.main_login' => 'getSecurity_Firewall_Map_Context_MainLoginService.php',
        ...
        $this->privates = array(
            ...
            'oc_platform.antispam' => true,
            'oc_platform.beta.html_adder' => true,
            'oc_platform.beta.listener' => true,
            'oc_platform.bigbrother.message_listener' => true,
            'oc_platform.bigbrother.message_notificator' => true,
            'oc_platform.doctrine_listener.application_creation' => true,
            'oc_platform.email.application_mailer' => true,
            'oc_platform.form.ckeditor' => true,
            'oc_platform.purger.advert' => true,
            'oc_platform.twig.antispam_extension' => true,
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('0YkGUIanx9', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('v9nc9RKrdx', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(${($_ = isset($this->services['oc_platform.twig.antispam_extension']) ? $this->services['oc_platform.twig.antispam_extension'] : $this->getOcPlatform_Twig_AntispamExtensionService()) && false ?: '_'});
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Hd5vZC+NMn', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4pk7VahelO', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('TondxSJ1Jq', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListener('kernel.response', array(0 => function () {
            return ${($_ = isset($this->services['oc_platform.beta.listener']) ? $this->services['oc_platform.beta.listener'] : $this->getOcPlatform_Beta_ListenerService()) && false ?: '_'};
        }, 1 => 'processBeta'), 0);
        $instance->addListener('oc_platform.post_message', array(0 => function () {
            return ${($_ = isset($this->services['oc_platform.bigbrother.message_listener']) ? $this->services['oc_platform.bigbrother.message_listener'] : $this->load('getOcPlatform_Bigbrother_MessageListenerService.php')) && false ?: '_'};
        }, 1 => 'processMessage'), 0);
        $instance->addListener('kernel.response', array(0 => function () {
    ...
    /**
     * Gets the private 'oc_platform.antispam' shared service.
     *
     * @return \OC\PlatformBundle\Antispam\OCAntispam
     */
    protected function getOcPlatform_AntispamService()
    {
        $this->services['oc_platform.antispam'] = $instance = new \OC\PlatformBundle\Antispam\OCAntispam(${($_ = isset($this->services['swiftmailer.mailer.default']) ? $this->services['swiftmailer.mailer.default'] : $this->getSwiftmailer_Mailer_DefaultService()) && false ?: '_'}, 50);
    ...
    /**
     * Gets the private 'oc_platform.beta.html_adder' shared service.
     *
     * @return \OC\PlatformBundle\Beta\BetaHTMLAdder
     */
    ...
    /**
     * Gets the private 'oc_platform.beta.listener' shared service.
     *
     * @return \OC\PlatformBundle\Beta\BetaListener
     */
    protected function getOcPlatform_Beta_ListenerService()
    {
        return $this->services['oc_platform.beta.listener'] = new \OC\PlatformBundle\Beta\BetaListener(${($_ = isset($this->services['oc_platform.beta.html_adder']) ? $this->services['oc_platform.beta.html_adder'] : $this->services['oc_platform.beta.html_adder'] = new \OC\PlatformBundle\Beta\BetaHTMLAdder()) && false ?: '_'}, '2019-06-30');
    }

    /**
     * Gets the private 'oc_platform.twig.antispam_extension' shared service.
     *
     * @return \OC\PlatformBundle\Twig\AntispamExtension
     */
    protected function getOcPlatform_Twig_AntispamExtensionService()
    {
        return $this->services['oc_platform.twig.antispam_extension'] = new \OC\PlatformBundle\Twig\AntispamExtension(${($_ = isset($this->services['oc_platform.antispam']) ? $this->services['oc_platform.antispam'] : $this->getOcPlatform_AntispamService()) && false ?: '_'});
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['security.authentication.provider.anonymous.main_login']) ? $this->services['security.authentication.provider.anonymous.main_login'] : $this->services['security.authentication.provider.anonymous.main_login'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider($this->getParameter('container.build_hash'))) && false ?: '_'};
    ...
    protected function getSecurity_Firewall_MapService()
    {
        return $this->services['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\ServiceLocator(array('security.firewall.map.context.dev' => function () {
            ...
            return ${($_ = isset($this->services['security.firewall.map.context.main_login']) ? $this->services['security.firewall.map.context.main_login'] : $this->load('getSecurity_Firewall_Map_Context_MainLoginService.php')) && false ?: '_'};
            ...
            yield 'security.firewall.map.context.main_login' => ${($_ = isset($this->services['security.request_matcher.ialwp3p']) ? $this->services['security.request_matcher.ialwp3p'] : $this->services['security.request_matcher.ialwp3p'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/login$')) && false ?: '_'};
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\OC\\CoreBundle/Resources/views'), '!OCCore');
        $instance->addPath(($this->targetDirs[3].'\\src\\OC\\FormulaireBundle/Resources/views'), 'OCFormulaire');
        $instance->addPath(($this->targetDirs[3].'\\src\\OC\\FormulaireBundle/Resources/views'), '!OCFormulaire');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'OCFormulaireBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\OC\\FormulaireBundle'),
                    'namespace' => 'OC\\FormulaireBundle',
                ),
                'OCUserBundle' => array(
                    'parent' => 'FOSUserBundle',
                    'path' => ($this->targetDirs[3].'\\src\\OC\\UserBundle'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'OCFormulaireBundle' => 'OC\\FormulaireBundle\\OCFormulaireBundle',
            ...
            'mailer_user' => 'audoinjean95@hotmail.com',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'audoinjean95@hotmail.com',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'audoinjean95@hotmail.com' => 'audoinjean95@hotmail.com',
            ),
            ...
            'fos_user.registration.form.type' => 'OC\\UserBundle\\Form\\RegistrationType',
