...
$d->addEventListener(array(0 => 'postPersist'), ${($_ = isset($this->services['oc_platform.doctrine_listener.application_creation']) ? $this->services['oc_platform.doctrine_listener.application_creation'] : $this->load('getOcPlatform_DoctrineListener_ApplicationCreationService.php')) && false ?: '_'});

return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory(array())) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfony3', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $d, array());
